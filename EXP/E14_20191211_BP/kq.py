...
for i in range(epoch*300):
    ...
    if i % 300 == 0:
        print(i / 300, 'err:', nn.calculate_total_error(training_sets))
        nn.LEARNING_RATE *= decay
    if i >= (epoch-1)*300:
        #print(nn.output_layer_outputs, training_outputs)
        ...
        #print(target_idx, output_idx, target_idx == output_idx)
        total += 1
        correct += output_idx == target_idx
print("Correct rate of training data set:\n" ,correct/total)
...
print("Correct rate of testing data set:\n" ,correct/total)