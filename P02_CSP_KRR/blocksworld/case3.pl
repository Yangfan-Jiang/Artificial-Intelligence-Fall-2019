...
start([clear(3),clear(4),clear(5),clear(b1),clear(b3),on(b2,1),on(b5,b2),on(b1,b5),on(b4,2),on(b3,b4)]).

mid([clear(b1),clear(b2),clear(b3),clear(b4),clear(b5),on(b2,1),on(b4,2),on(b3,3),on(b1,4),on(b5,5)]).

end([on(b2,2),on(b1,b2),on(b5,b1),on(b3,b5),on(b4,b3),clear(b4)]).
